...
|
+---------------------------------------+
| Phase 3: Executive BI (Completed) | --> Interactive Power BI C-Suite Performance Dashboard, direct-connected to BigQuery.
+---------------------------------------+
...
* Total Profit: **$1.47M**
* Profit Margin: **11.61%**
* Toxic Sales Share: **2.94%**
* Distressed Orders: **7,541**
...
| `query5_logistics_efficiency_check.sql` | Operational Drag Analysis | Direct temporal calculation comparing regional lead times against global averages. |
